class Chat {
    constructor(chatWidget) {
        ...
        this.messagesArea = chatWidget.querySelector('.chat-widget__messages-container');
        this.messages = chatWidget.querySelector('.chat-widget__messages');
        this.firstMessageFromRobot = chatWidget.querySelector('.message__time');
        this.collectionMessagesBot = [
            'Здрасти, досвиданья',
            'Я есть Груд',
        ...
        this.counter = 0;
        this.idTimeout = null;
        this.heightLastMessage;
        this.heightPreLastMessage;
    }
}
